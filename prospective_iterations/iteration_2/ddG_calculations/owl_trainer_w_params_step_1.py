...
save_folder_base=f"{pocket_fit_folder}/prediction_step_1"
script_folder=f"{pocket_fit_folder}/prediction_step_0/repr_scan_step_0_on_preliminary_calc_ddG"
#step0_db_file=f"{pocket_fit_folder}/ddG_step_1_sigmahole_scaled_dummy_masses/stable_ligs.pickle"
...
def train_model_with_settings(settings_fname, redo=False, device=torch.device("cpu"), show_progress=False,
    ...
    print("# of training ligands found:", len(ligs))
    #raise()
